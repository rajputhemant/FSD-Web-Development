...
const Home = () => {
  ...
  return (
    <>
    <div className="h-120 mt-2 shadow-blue-200">
       ...
       <div className="mt-2  shadow-blue-200" >
        <img src={lips} className="w-full rounded-lg" alt="Lips"
           
        />
        <button className="relative bottom-30  ms-20 bg-orange-500 text-white px-4 py-2 rounded-md hover:bg-amber-400 hover:scale-110"onClick={() =>navigate("/product")}>By Now</button>
      </div>
        ...
        <div className="flex   justify-around mt-7 gap-5">
          ...
          <button className="absolute w-90  mt-3 bg-black text-white px-4 py-2 rounded-md hover:bg-amber-400 hover:scale-105" onClick={() =>navigate("/product")}>ADD TO CART</button>
          </div>
          <div className="relative group w-90">
